...
class MovingEye(Env):
    ...
    def step(self, action):
        ...
        if x != self._rangefinder_cutoff and len(self._data.contact.geom2) > 0:
            ...
            # if geom2 == 2 or geom2 == 5 or geom2 == 14 or geom2 == 17:
            #     print('The margin actions are: {}, and the contact grid idx was {}, the distance was {}'.format(action, geom2, x))
            # else:
            #     print('The normal actions are: {}, and the contact grid idx was {}, the distance was {}'.format(action,
            #                                                                                                     geom2,
            #                                                                                                     x))
            # TODO debug.
